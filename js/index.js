...
function getData(query, page){
    return fetch(`https://api.themoviedb.org/3/search/movie?include_adult=true&page=${page}&query=${query}&language=ru&api_key=39e0b104194205a78342a95c60fb7bee`)
}
...
function createDetailsCard(FilmDetails) {
    ...
    tableWrap.classList.add("table-wrap");
        ...
        let tbody = document.createElement("tbody");
            ...
            let releaseDate = createDateRow("Дата релиза", FilmDetails.release_date);
...
function createDateRow(name, value) {
    ...
    let date = new Date(value).toLocaleString("ru", options)
    let tr = document.createElement("tr");
    let td1 = document.createElement("td");
    td1.innerHTML = name;
